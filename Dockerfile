...
run sed -i 's/main$/main universe/' /etc/apt/sources.list && apt-get update && apt-get -y install build-essential libedit2 libglu1-mesa-dev libgmp-dev libgmp10 zlib1g-dev freeglut3-dev wget sudo
